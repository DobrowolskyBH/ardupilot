...
#include <math.h>
#include <AP_Proximity/AP_Proximity.cpp>
#include <AP_Proximity/AP_Proximity.h>

#if MODE_AUTO_AVOID_ENABLED == ENABLED

/*Esse é um modo de voo baseado no modo AUTO que possui as mesmas funções, mas com a inclusão de detectção e desvio de obstaculos
 *
...
bool ModeAuto_Avoid::init(bool ignore_checks)
{
...
bool ModeAuto_Avoid::loiter_start()
{
...
void ModeAuto_Avoid::takeoff_start(const Location& dest_loc)
{
    _mode = Auto_TakeOff;
...
void ModeAuto_Avoid::wp_start(const Location& dest_loc)
{
    _mode = Auto_WP;
...
void ModeAuto_Avoid::land_start()
{
...
//==========================================================================
// auto_land_start - initialises controller to implement a landing
void ModeAuto_Avoid::land_start(const Vector3f& destination)
{
    _mode = Auto_Land;
...
void ModeAuto_Avoid::circle_movetoedge_start(const Location &circle_center, float radius_m)
{
    // set circle center
...
void ModeAuto_Avoid::circle_start()
{
    _mode = Auto_Circle;
...
void ModeAuto_Avoid::spline_start(const Location& destination, bool stopped_at_start,
...
void ModeAuto_Avoid::nav_guided_start()
{
...
//==========================================================================
bool ModeAuto_Avoid::is_landing() const
{
    switch(_mode) {
    case Auto_Land:
        return true;
...
//==========================================================================
bool ModeAuto_Avoid::is_taking_off() const
{
...
void ModeAuto_Avoid::payload_place_start()
{
    // set target to stopping point
    Vector3f stopping_point;
    loiter_nav->get_stopping_point_xy(stopping_point);
...
//==========================================================================
//Aqui é onde o controle do drone é feito para os waypoints
// start_command - this function will be called when the ap_mission lib wishes to start a new command
bool ModeAuto_Avoid::start_command(const AP_Mission::Mission_Command& cmd)
{
...
void ModeAuto_Avoid::exit_mission()
{
    // play a tone
...
bool ModeAuto_Avoid::do_guided(const AP_Mission::Mission_Command& cmd)
{
...
//==========================================================================
uint32_t ModeAuto_Avoid::wp_distance() const
{
    switch (_mode) {
    case Auto_Circle:
...
//==========================================================================
int32_t ModeAuto_Avoid::wp_bearing() const
{
    switch (_mode) {
    case Auto_Circle:
...
//==========================================================================
// update mission
void ModeAuto_Avoid::run_autopilot()
{
    mission.update();
}
...
bool ModeAuto_Avoid::verify_command(const AP_Mission::Mission_Command& cmd)
{
...
void ModeAuto_Avoid::takeoff_run()
{
    auto_takeoff_run();
}
...
//      called by auto_run at 100hz or more
void ModeAuto_Avoid::spline_run()
{
    // if not armed set throttle to zero and exit immediately
    if (is_disarmed_or_landed()) {
        make_safe_spool_down();
...
//      called by auto_run at 100hz or more
void ModeAuto_Avoid::circle_run()
{
    // process pilot's yaw input
    float target_yaw_rate = 0;
    if (!copter.failsafe.radio) {
...
//      called by auto_run at 100hz or more
void ModeAuto_Avoid::nav_guided_run()
{
...
//      called by auto_run at 100hz or more
void ModeAuto_Avoid::loiter_run()
{
    // if not armed set throttle to zero and exit immediately
    if (is_disarmed_or_landed()) {
        make_safe_spool_down();
...
//      called by auto_run at 100hz or more
void ModeAuto_Avoid::loiter_to_alt_run()
{
...
void ModeAuto_Avoid::payload_place_start(const Vector3f& destination)
{
...
//      called by auto_run at 100hz or more
void ModeAuto_Avoid::payload_place_run()
{
...
//==========================================================================
bool ModeAuto_Avoid::payload_place_run_should_run()
{
    // must be armed
    if (!motors->armed()) {
        return false;
...
//==========================================================================
void ModeAuto_Avoid::payload_place_run_loiter()
{
    // loiter...
    land_run_horizontal_control();
...
//==========================================================================
void ModeAuto_Avoid::payload_place_run_descend()
{
    land_run_horizontal_control();
    land_run_vertical_control();
}
...
Location ModeAuto_Avoid::terrain_adjusted_location(const AP_Mission::Mission_Command& cmd) const
{
...
void ModeAuto_Avoid::do_takeoff(const AP_Mission::Mission_Command& cmd)
{
...
//==========================================================================
Location ModeAuto_Avoid::loc_from_cmd(const AP_Mission::Mission_Command& cmd) const
{
...
void ModeAuto_Avoid::do_nav_wp(const AP_Mission::Mission_Command& cmd)
{
...
void ModeAuto_Avoid::do_land(const AP_Mission::Mission_Command& cmd)
{
...
void ModeAuto_Avoid::do_loiter_unlimited(const AP_Mission::Mission_Command& cmd)
{
...
void ModeAuto_Avoid::do_circle(const AP_Mission::Mission_Command& cmd)
{
...
// note: caller should set yaw_mode
void ModeAuto_Avoid::do_loiter_time(const AP_Mission::Mission_Command& cmd)
{
...
// note: caller should set yaw_mode
void ModeAuto_Avoid::do_loiter_to_alt(const AP_Mission::Mission_Command& cmd)
{
    // re-use loiter unlimited
    do_loiter_unlimited(cmd);
    _mode = Auto_LoiterToAlt;
...
void ModeAuto_Avoid::do_spline_wp(const AP_Mission::Mission_Command& cmd)
{
...
void ModeAuto_Avoid::do_nav_guided_enable(const AP_Mission::Mission_Command& cmd)
{
    if (cmd.p1 > 0) {
...
void ModeAuto_Avoid::do_guided_limits(const AP_Mission::Mission_Command& cmd)
{
...
void ModeAuto_Avoid::do_nav_delay(const AP_Mission::Mission_Command& cmd)
{
...
void ModeAuto_Avoid::do_wait_delay(const AP_Mission::Mission_Command& cmd)
{
...
//==========================================================================
void ModeAuto_Avoid::do_within_distance(const AP_Mission::Mission_Command& cmd)
{
    condition_value  = cmd.content.distance.meters * 100;
}

//==========================================================================
void ModeAuto_Avoid::do_yaw(const AP_Mission::Mission_Command& cmd)
{
...
void ModeAuto_Avoid::do_change_speed(const AP_Mission::Mission_Command& cmd)
{
...
//==========================================================================
void ModeAuto_Avoid::do_set_home(const AP_Mission::Mission_Command& cmd)
{
...
void ModeAuto_Avoid::do_roi(const AP_Mission::Mission_Command& cmd)
{
...
//==========================================================================
// point the camera to a specified angle
void ModeAuto_Avoid::do_mount_control(const AP_Mission::Mission_Command& cmd)
{
#if MOUNT == ENABLED
...
void ModeAuto_Avoid::do_winch(const AP_Mission::Mission_Command& cmd)
{
...
void ModeAuto_Avoid::do_payload_place(const AP_Mission::Mission_Command& cmd)
{
    // if location provided we fly to that location at current altitude
    if (cmd.content.location.lat != 0 || cmd.content.location.lng != 0) {
        // set state to fly to location
...
void ModeAuto_Avoid::do_RTL(void)
{
...
bool ModeAuto_Avoid::verify_takeoff()
{
...
bool ModeAuto_Avoid::verify_land()
{
    bool retval = false;
...
bool ModeAuto_Avoid::verify_payload_place()
{
...
//==========================================================================
bool ModeAuto_Avoid::verify_loiter_unlimited()
{
    return false;
}
...
bool ModeAuto_Avoid::verify_loiter_time(const AP_Mission::Mission_Command& cmd)
{
...
bool ModeAuto_Avoid::verify_loiter_to_alt()
{
    if (loiter_to_alt.reached_destination_xy &&
...
bool ModeAuto_Avoid::verify_RTL()
{
...
bool ModeAuto_Avoid::verify_wait_delay()
{
...
//==========================================================================
bool ModeAuto_Avoid::verify_within_distance()
{
...
bool ModeAuto_Avoid::verify_yaw()
{
...
bool ModeAuto_Avoid::verify_nav_wp(const AP_Mission::Mission_Command& cmd)
{
...
bool ModeAuto_Avoid::verify_circle(const AP_Mission::Mission_Command& cmd)
{
...
bool ModeAuto_Avoid::verify_spline_wp(const AP_Mission::Mission_Command& cmd)
{
    // check if we have reached the waypoint
    if ( !copter.wp_nav->reached_wp_destination() ) {
        return false;
...
bool ModeAuto_Avoid::verify_nav_guided_enable(const AP_Mission::Mission_Command& cmd)
{
...
bool ModeAuto_Avoid::verify_nav_delay(const AP_Mission::Mission_Command& cmd)
{
...
{   
    ...
    {   
        ...
        {*/
            ...
            //pos_control.set_desired_velocity_xy(velocidade.x, velocidade.y)
            //_pos_control.set_desired_velocity_xy(velocidade.x, velocidade.y)
            //gcs().send_text(MAV_SEVERITY_CRITICAL, "VELOCIDADE ANTES %5.3f", (double)copter.wp_nav->get_default_speed_xy());
            //velocidade.x *= copter.wp_nav->get_default_speed_xy();
            //velocidade.y *= copter.wp_nav->get_default_speed_xy();
            //copter.set_target_velocity_NED(velocidade);
            //copter.mode_avoid_adsb.set_velocity(velocidade);
            //gcs().send_text(MAV_SEVERITY_CRITICAL, "VELOCIDADE DEPOIS %5.3f", (double)copter.wp_nav->get_default_speed_xy());
