...
public:
    ...
    enum class Number : uint8_t {
        ...
        AUTO_AVOID =   27, // fully automatic waypoint control using mission commands and obstacle avoidance using LiDAR
...
//Definindo a classe do novo modo de voo

class ModeAuto_Avoid : public Mode
{
public:
    // inherit constructor
    using Mode::Mode;
    ...
    AP_Mission mission{
        FUNCTOR_BIND_MEMBER(&ModeAuto_Avoid::start_command, bool, const AP_Mission::Mission_Command &),
        FUNCTOR_BIND_MEMBER(&ModeAuto_Avoid::verify_command, bool, const AP_Mission::Mission_Command &),
        FUNCTOR_BIND_MEMBER(&ModeAuto_Avoid::exit_mission, void)};


protected:
    const char *name() const override { return "Auto_Avoid"; }
    const char *name4() const override { return "Auto_Avoid"; }
